...
export default function BannerImage() {
  return (
    <div className="relative h-screen md:px-20 px-3 md:py-10 py-5 ">
      ...
      <div className="absolute top-3 left-0 right-0 z-20 md:pt-36 pt-40 flex flex-col justify-center items-center text-white text-xl p-4">
        <p className="font-serif font-bold md:text-5xl text-xl md:px-24 px-5 text-center text-white">
        ...
        <div className="flex md:flex-row flex-col md:space-y-0 space-y-5 justify-center items-center md:space-x-10 pt-10">
          <Link to="/under">
          <button className="md:w-96 w-full md:px-0 px-5 py-3 bg-white font-serif text-gray rounded-full">
          Commencez à suivre votre alimentation
          </button>
          </Link>
          <Link to="/under">
          <button className="md:w-96 py-3 w-full  md:px-0 px-10 border-2 font-serif bg-verte border-solid border-verte text-graylight rounded-full">

...
export default function Recipes(){
    return(
        <div className='flex md:flex-row flex-col-reverse justify-center items-center font-serif  md:px-20 px-12 space-x-10 md:pt-0' data-aos="fade-up" data-aos-once="false">
            ...
            <button className="text-lg md:px-9 py-2 px-20 bg-verte rounded-lg text-white hover:bg-gray-700 transition duration-300">
                ...
                <div className='grid grid-cols-1 gap-0 md:w-1/2 w-full' data-aos="fade-right" data-aos-once="false">
